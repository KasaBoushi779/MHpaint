...
/* Taken from accepted answer in 
"JavaScript: Check if mouse button down?" 
on Stack Exchange. Variable name changed. 
...
function draw(e){
    /*Code for the "e" stuff taken from question in 
    "Real mouse position in canvas" on Stack Overflow. 
    All other code is original.
    Link: https://stackoverflow.com/questions/17130395/real-mouse-position-in-canvas */
    var canvas = document.getElementById("canvas");
    var ctx = canvas.getContext("2d");
    mouseX = e.clientX;
    mouseY = e.clientY;
    ...
    /*I didn't find any methods that let me draw while the 
